...
#include "my_msgs/msg/detail/bbox_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_msgs::msg::BboxMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_msgs::msg::BboxMsg & ros_message)
{
  // Member: index
  cdr >> ros_message.index;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msgs::msg::BboxMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_msgs::msg::BboxMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_msgs::msg::BboxMsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BboxMsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_msgs::msg::BboxMsg *>(
...
static size_t _BboxMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BboxMsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BboxMsg__callbacks = {
  "my_msgs::msg",
  "BboxMsg",
...
static rosidl_message_type_support_t _BboxMsg__handle = {
...
{
  return &my_msgs::msg::typesupport_fastrtps_cpp::_BboxMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_msgs, msg, BboxMsg)() {
  return &my_msgs::msg::typesupport_fastrtps_cpp::_BboxMsg__handle;
}
